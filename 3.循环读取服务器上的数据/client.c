/**
 * 绑定客户端ip和端口
 * 参考文章：http://zhoulifa.bokee.com/6062989.html
 * 启动服务端：nc -l 10000 < something.txt  (something.txt是准备好的比较长的内容)
 * 启动本客户端： ./a.out 127.0.0.1 10000 127.0.0.1 10001
 * 运行结果：客户端打印输出something.txt中的内容，每次展示10个字节
 * */
#include <stdio.h>
#include <string.h>
#include <errno.h>
